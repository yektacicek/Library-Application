...
<body>
	...
	<script>
		...
		function insertBook() {
			...
			xhttp.open("POST",
					"http://localhost:8080/kutuphaneApp/Service/book/bookUpload",
					true);
		...
		function skipTime() {
			...
			xhttp.open("POST",
					"http://localhost:8080/kutuphaneApp/Service/time/skipTime",
					true);
		...
		function listUsers() {
			...
			xhttp.open("GET","http://localhost:8080/kutuphaneApp/Service/user/listUsersGet",true);
			//xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xhttp.send();
		}
	</script>
