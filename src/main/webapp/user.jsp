...
<body>
	...
	<script>
		function searchBook() {
			...
			xhttp.open("POST",
					"http://localhost:8080/kutuphaneApp/Service/book/searchBook", true);
		...
		function listBooks() {
			...
			xhttp.open("GET","http://localhost:8080/kutuphaneApp/Service/book/listBooksGet",true);
		...
		function takeBook() {
			...
			xhttp.open("POST",
					"http://localhost:8080/kutuphaneApp/Service/book/takeBook",
					true);
			xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		...
		function giveBook() {
			...
			xhttp.open("POST",
					"http://localhost:8080/kutuphaneApp/Service/book/giveBook",
					true);
